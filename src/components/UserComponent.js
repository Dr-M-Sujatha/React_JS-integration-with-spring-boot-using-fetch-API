...
class UserComponent extends React.Component{
    ...
    render(){
      return(  <div>
            <h1 className='text-center' style={{backgroundColor: "orange"}}> USERS LIST</h1>
            <table className='table table-striped'>
                <thead>
                    <tr>
                        <td style={{backgroundColor: "grey"}}>USER ID</td>
                        <td style={{backgroundColor: "grey"}}>USER FIRSTNAME</td>
                        <td style={{backgroundColor: "grey"}}>USER LASTNAME</td>
